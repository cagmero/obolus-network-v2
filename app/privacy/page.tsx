      ...
      <div className="flex flex-col gap-8 py-8 font-mono">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="glass-card rounded-2xl p-8 border-l-4 border-l-white/10 relative overflow-hidden group">
            <p className="text-foreground/50 text-[10px] font-bold uppercase tracking-[0.2em] mb-2">fhEVM Chain</p>
            <div className="flex items-baseline gap-2">
              <h1 className="text-white text-4xl font-black tracking-tighter tabular-nums uppercase">ZAMA_DEVNET</h1>
            </div>
